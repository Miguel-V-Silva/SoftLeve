...
@WebServlet(urlPatterns = { "/cadastrar-desenvolvedor", "/inserir-desenvolvedor", "/excluir-desenvolvedor", "/editar-desenvolvedor" })
public class DesenvolvedorServlet extends HttpServlet implements Serializable {
	...
	private void mostrarCadastroDesenvolvedor(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher("paginas/desenvolvedor/cadastrar-desenvolvedor.jsp");
